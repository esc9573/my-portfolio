...
export default function Navbar() {
    ...
    const cvDirectLink = "https://drive.google.com/uc?export=download&id=1P_ErvMVzfGP3q_FUTrQ1SGDO2v2HCEHA";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="relative flex items-center justify-between h-20">
                    ...
                    <nav className="absolute left-1/2 -translate-x-1/2 hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
                        <a href="#hero" className="hover:text-emerald-400 transition-colors whitespace-nowrap">About</a>
                        <a href="#projects" className="hover:text-emerald-400 transition-colors whitespace-nowrap">Projects</a>
                        <a href="#CertificatesSection" className="hover:text-emerald-400 transition-colors whitespace-nowrap">Skills & Certificates</a>
                        <a href="#contact" className="hover:text-emerald-400 transition-colors whitespace-nowrap">Contact</a>
                    </nav>
                ...
                <div className="md:hidden bg-[#0a0c10]/95 backdrop-blur-xl border-t border-slate-800/80">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5">
                        <nav className="flex flex-col items-center gap-4 text-slate-300">
                            <a href="#hero" onClick={() => setIsOpen(false)} className="hover:text-emerald-400 transition-colors py-1">About</a>
                            <a href="#projects" onClick={() => setIsOpen(false)} className="hover:text-emerald-400 transition-colors py-1">Projects</a>
                            <a href="#CertificatesSection" onClick={() => setIsOpen(false)} className="hover:text-emerald-400 transition-colors py-1">Skills & Certificates</a>
                            <a href="#contact" onClick={() => setIsOpen(false)} className="hover:text-emerald-400 transition-colors py-1">Contact</a>
                        </nav>
